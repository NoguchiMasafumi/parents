var value = new Vue({
    ...
    data:{
        ...
        ar_part:[
            ...
            {part:'⺌',part_name:'しょう　しょうがしら　なおがしら'},
            {part:'⺮',part_name:'たけ たけかんむり'},
            {part:'冂',part_name:'けいがまえ まきがまえ どうがまえ えんがまえ'},
            {part:'肉',part_name:'にく　にくづき'},
            {part:'馬',part_name:'うま うまへん'},
            {part:'⼉',part_name:'にんにょう　ひとあし'},
            {part:'麦',part_name:'むぎへん　ばくにょう'},
            {part:'父',part_name:'ちち'},
            {part:'風',part_name:'かぜ'},
            ...
            {part:'戶',part_name:'と　とだれ　とかんむり　とびらのと'},
            ...
            {part:'罒',part_name:'め　めへん'},
            {part:'飛',part_name:'とぶ'},
            {part:'阜',part_name:'ぎふのふ　こざと　こざとへん　おか'},
            {part:'勹',part_name:'つつみがまえ'},
            {part:'覀',part_name:'おおいかんむり　にし　かなめのかしら'},
            ...
            {part:'己',part_name:'おのれ'},
            {part:'㔾',part_name:'ふしづくり　わりふ'},
            ...
            {part:'乚',part_name:'おつ　おつにょう　つりばり'},
